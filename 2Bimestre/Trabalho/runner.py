...
while True:
    ...
    if user is None:
        ...
        title = largeFont.render("Jogue Jogo da Velha", True, white)
        titleRect = title.get_rect()
        titleRect.center = ((width / 2), 50)
        screen.blit(title, titleRect)

        playXButton = pygame.Rect((width / 8), (height / 2), width / 4, 50)
        playX = mediumFont.render("Jogue como X", True, black)
        ...
        playO = mediumFont.render("Jogue como O", True, black)
        ...
        if game_over:
            ...
            again = mediumFont.render("Jogue novamente", True, black)
